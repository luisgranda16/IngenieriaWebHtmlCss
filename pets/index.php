	...
	<section class="doctor">
		<div class="cuadro-doctor1">
			...
			<div class="texto-encima">
				<h3 class="doctor-texto">Dr. Marta Gomez</h3>
			</div>
		</div>
		<div class="cuadro-doctor1">
			<img src="images/doctor2.jpg">
			<div class="texto-encima">
			<h3 class="doctor-texto">Dr. Mateo Flores</h3>
				<p></p>
			</div>
		</div>
		<div class="cuadro-doctor1">
			...
			<div class="texto-encima">
				<h3 class="doctor-texto">Dr. Gabriela Mendoza</h3>	
				<p></p>
			</div>
		</div>
		<div class="cuadro-doctor1">
			...
			<div class="texto-encima">
				<h3 class="doctor-texto">Dr. Jorge Masa</h3>	
				<p></p>
			</div>
		</div>
	</section>	
